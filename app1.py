...
try:
    best_dt_model = load("best_dt_model.joblib")  # Use joblib to load the model
...
def main():
    ...
    Medical_Conditions = st.selectbox("Medical Conditions", options=[
        'No Data', 'Eczema', 'Dermatosis', 'Ringworm', 'Psoriasis', 
    ...
    Medications_Treatments = st.selectbox("Medications & Treatments", options=[
        'No Data', 'Antibiotics', 'Antifungal Cream', 'Accutane', 
    ...
    Nutritional_Deficiencies = st.selectbox("Nutritional Deficiencies", options=[
        'No Data', 'Magnesium deficiency', 'Protein deficiency', 
    ...
    Medical_Conditions_map = {
        'No Data': 1, 'Eczema': 2, 'Dermatosis': 3, 'Ringworm': 4, 
        'Psoriasis': 5, 'Alopecia Areata': 6, 'Scalp Infection': 7, 
        'Seborrheic Dermatitis': 8, 'Dermatitis': 9, 'Thyroid Problems': 10,
        'Androgenetic Alopecia': 11
    }
    Medications_Treatments_map = {
        'No Data': 1, 'Antibiotics': 2, 'Antifungal Cream': 3, 'Accutane': 4, 
        'Chemotherapy': 5, 'Steroids': 6, 'Rogaine': 7, 
        'Blood Pressure Medication': 8, 'Immunomodulators': 9,
